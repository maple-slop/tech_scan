...
RULES = [
    ...
    Rule("ASP.NET", DIM_BACKEND, 90, "asp.net x-powered-by header", "x-powered-by", r"\basp\.net\b"),
    ...
    Rule("ASP.NET Core", DIM_BACKEND, 90, "kestrel server header", "server", r"\bkestrel\b"),
